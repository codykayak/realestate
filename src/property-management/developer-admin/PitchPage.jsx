    ...
    <div className={`${styles.card} ${pitch.moduleCard}`}>
      <div className={pitch.moduleHead}>
        ...
        <div>
          ...
          <div className={styles.hint}>{mod.tagline}</div>
        </div>
    ...
    <div className={pitch.pitchRoot}>
      ...
      <section className={pitch.hero}>
        ...
        <div className={pitch.heroVisual}>
          <img src={HERO_IMG} alt="Multifamily community — illustrative" className={pitch.heroImg} />
        </div>
      </section>
      ...
      <section className={pitch.section}>
        ...
        <div className={`${styles.grid} ${styles.cols3}`}>
          <div className={styles.card}>
            ...
            <p className={pitch.cardBody}>Leasing and maintenance teams are understaffed; growth absorbs headcount instead of margin.</p>
          </div>
          <div className={styles.card}>
            <div className={styles.metricLabel}>Vacancy is expensive</div>
            <p className={pitch.cardBody}>Each vacant day ≈ lost rent. Slow speed-to-lead and manual screening extend downtime.</p>
          </div>
          <div className={styles.card}>
            <div className={styles.metricLabel}>Risk is rising</div>
            <p className={pitch.cardBody}>Application fraud and document tampering drive evictions ($3k–$10k+ per case) and unit damage.</p>
          </div>
        </div>
      </section>
